...
class JavaParser(Parser):
            ...
            while (
                ...
                and (
                    ...
                    & (
                        ...
                        | (1 << JavaParser.PRIVATE)
                        | (1 << JavaParser.PROTECTED)
                        | (1 << JavaParser.PUBLIC)
                        | (1 << JavaParser.STATIC)
                        | (1 << JavaParser.STRICTFP)
                    )
                )
                != 0
            ) or (
            ...
            while (
                ...
                and (
                    ...
                    & (
                        ...
                        | (1 << JavaParser.STATIC)
                        | (1 << JavaParser.STRICTFP)
                        | (1 << JavaParser.SYNCHRONIZED)
                        | (1 << JavaParser.TRANSIENT)
                        | (1 << JavaParser.VOID)
                        | (1 << JavaParser.VOLATILE)
                        | (1 << JavaParser.LBRACE)
                    )
                )
                != 0
    ...
    def variableInitializer(self):
        ...
        try:
            ...
            if token in [JavaParser.LBRACE]:
                ...
                JavaParser.THIS,
                JavaParser.VOID,
                JavaParser.DECIMAL_LITERAL,
                JavaParser.HEX_LITERAL,
                JavaParser.OCT_LITERAL,
                JavaParser.BINARY_LITERAL,
                JavaParser.FLOAT_LITERAL,
                JavaParser.HEX_FLOAT_LITERAL,
                JavaParser.BOOL_LITERAL,
                JavaParser.CHAR_LITERAL,
                JavaParser.STRING_LITERAL,
                JavaParser.NULL_LITERAL,
                JavaParser.LPAREN,
                JavaParser.LT,
                JavaParser.BANG,
                JavaParser.TILDE,
            ...
            if (
                ...
                and (
                    ...
                    & (
                        ...
                        | (1 << JavaParser.THIS)
                        | (1 << JavaParser.VOID)
                        | (1 << JavaParser.DECIMAL_LITERAL)
                        | (1 << JavaParser.HEX_LITERAL)
                        | (1 << JavaParser.OCT_LITERAL)
                        | (1 << JavaParser.BINARY_LITERAL)
                        | (1 << JavaParser.FLOAT_LITERAL)
                        | (1 << JavaParser.HEX_FLOAT_LITERAL)
                        | (1 << JavaParser.BOOL_LITERAL)
                        | (1 << JavaParser.CHAR_LITERAL)
                        | (1 << JavaParser.STRING_LITERAL)
                        | (1 << JavaParser.NULL_LITERAL)
                        | (1 << JavaParser.LPAREN)
                        | (1 << JavaParser.LBRACE)
                    )
                )
    ...
    def formalParameters(self):
        ...
        try:
            ...
            if (
                ...
                or _la == JavaParser.AT
                or _la == JavaParser.IDENTIFIER
            ):
                self.state = 640
    ...
    def floatLiteral(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == JavaParser.FLOAT_LITERAL or _la == JavaParser.HEX_FLOAT_LITERAL
            ):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                            ...
                            (
                                ...
                                and (
                                    ...
                                    & (
                                        ...
                                        | (1 << (JavaParser.URSHIFT_ASSIGN - 70))
                                    )
                                )
                                != 0
                            )
